...
urlpatterns = [
    ...
    path('category/<int:id>/', viewsCRUD.category_form, name='category_update'),
    # get and post req. for update operation
    path('category/delete/<int:id>/', viewsCRUD.category_delete, name='category_delete'),
    path('category/list/', viewsCRUD.category_list, name='category_list'),
    ...
    path('comment/<int:pk>/<int:id>/', views.addComment, name='update-comment'),
    # get and post req. for update operation
